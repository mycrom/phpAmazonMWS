...
class AmazonOrderList extends AmazonOrderCore implements \Iterator
{
     ...
     * @param array|string $filter <p>A list of Payment Methods, or a single type string. Set to NULL to remove the option.</p>
     * @return boolean <b>FALSE</b> if improper input
     */
     ...
     * @param string $filter <p>A single address string. Set to NULL to remove the option.</p>
     * @return boolean <b>FALSE</b> if improper input
     */
